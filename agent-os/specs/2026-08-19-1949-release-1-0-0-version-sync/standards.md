# Standards for Release 1.0.0 — version sync

One standard applies. The remaining 16 categories in
`agent-os/standards/index.yml` describe the parent Canvas application (BLE
mesh, SignalR, Koin, ScreenModel state) and have no bearing on a build-config
